...
<Meta title="Welcome | Getting Started / Documentation Guidelines" />
...
- Display the component's api using the `<Props of={Button} />` component from storybook docs
...
[Component Story Format (CSF)](https://storybook.js.org/docs/react/api/csf) is the recommended way to write stories. It's an open standard based on ES6 modules that is portable beyond Storybook. The below example is of the Button component and it explains how we should write our stories.
